...
public class Reusable_Actions_Loggers {
    ...
    public static String getTextMethod(WebDriver driver, String xpath, ExtentTest logger, String elementName){
        ...
        logger.log(LogStatus.INFO,"Able to capture text " + elementName);
...
/*
    public static void clickbyIndex(WebDriver driver, ){
        WebDriverWait wait = new WebDriverWait(driver,15);
...
String image = logger.addScreenCapture(snPath + fileName);
 ...
 e.printStackTrace();
    ...
    public static String getDateTIME() {
        ...
        String strDateTIME;
        sdfDateTime = new SimpleDateFormat("yyyMMdd'_'HHmmss'-'SSS");
        Date now = new Date();
